                        ...
                        <nav class="navbar navbar-expand-lg navbar-light"> <a class="navbar-brand" href="#">Menu</a>
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="{{route('service')}}">Services</a> <i class="fas fa-caret-down"></i>
                                        <ul class="submenu">
                                            <li><a href="services.html">Services</a></li>
                                            <li><a href="services_details.html">Service Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item"><a class="nav-link" href="{{route('gallery')}}">Gallery</a> </i>
                                        {{-- <ul class="submenu">
                                            <li><a href="gallery.html">Gallery Style 01</a></li>
                                            <li><a href="gallery_02.html">Gallery Style 02</a></li>
                                            <li><a href="gallery_03.html">Gallery Style 03</a></li>
                                        </ul> --}}
                                    </li>
                                    <li class="nav-item"><a class="nav-link" href="{{route('shop')}}">Shop</a></i>
                                        {{-- <ul class="submenu">
